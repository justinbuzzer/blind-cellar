 ...
 * Links to the existing per-bottle reveal screen
 * (/session/[publicId]/bottle/[wineId]/reveal) for each already-revealed
 * bottle, and to the final leaderboard once every bottle in the course has
 * been revealed. Live updates use the same convention as
 * app/session/[publicId]/active/page.tsx.
 */
